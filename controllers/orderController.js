...
//       SELECT c.FullName AS customerName, r.RoomID
// FROM Customer c
...
//   }
// };
exports.getCustomerAndRoom = (req, res) => {
    const query = "SELECT c.FullName AS customerName, r.RoomID FROM Customer c JOIN OrderSV o ON c.CustomerID = o.CustomerID JOIN OrderDetail od ON od.OrderID = o.OrderID JOIN Room r ON r.RoomID = od.RoomID";
